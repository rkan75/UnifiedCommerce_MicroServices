...
/** Filled heart icon in green for "in wishlist" state */
function HeartFilledGreen({ className }: { className?: string }) {
  return (
    <svg
...
export default function AddToWishlistButton({
    ...
    return (
      <button
        ...
        className={clx(
          ...
          inWishlist
            ? "text-green-600 border-green-200 bg-green-50/90 hover:bg-green-50"
      ...
      >
        {inWishlist ? (
          <HeartFilledGreen className="w-4 h-4 text-green-600" />
        ) : (
  ...
  return (
    <Button
      ...
      isLoading={isLoading}
      className={clx(
        inWishlist && "text-green-600 border-green-200 bg-green-50 hover:bg-green-100",
        className
      )}
      data-testid={dataTestId ?? "add-to-wishlist-button"}
    >
      {inWishlist ? (
        <HeartFilledGreen className="w-4 h-4 mr-1.5 text-green-600" />
      ) : (
