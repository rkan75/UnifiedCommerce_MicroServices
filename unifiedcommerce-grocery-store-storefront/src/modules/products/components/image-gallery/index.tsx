...
const ImageGallery = ({ images }: ImageGalleryProps) => {
  ...
  return (
    <div className="flex flex-col items-center relative w-full max-w-[600px] mx-auto tablet:mx-0">
      ...
      <Container
        key={mainImage.id}
        className="relative aspect-[29/34] w-full max-h-[min(48vh,420px)] tablet:max-h-[min(55vh,480px)] small:max-h-[min(58vh,540px)] overflow-hidden bg-ui-bg-subtle rounded-rounded shrink-0"
        id={mainImage.id}
      >
        {!!mainImage.url && (
          <Image
