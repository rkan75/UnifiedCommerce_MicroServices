/**
 * Admin auth validation — no Medusa framework outbox validation.
 * GET or POST with JWT in Authorization: Bearer or medusa_admin_token cookie.
 * Returns 200 + auth context if valid, 401 otherwise.
 */
