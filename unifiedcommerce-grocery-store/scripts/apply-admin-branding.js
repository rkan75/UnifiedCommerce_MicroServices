#!/usr/bin/env node
/**
 * Applies TCS branding to the Medusa admin dashboard after install:
 * - Welcome text: "Welcome to Medusa" -> "Welcome to TCS Unified AI Commerce" (login + invite)
 * - Logo: Replace Medusa SVG with img pointing to /admin/logo (tcslogo.png)
...
const WELCOME_NEW = '"title": "Welcome to TCS Unified AI Commerce"';
...
function main() {
  ...
  if (changed) {
    console.log("apply-admin-branding: TCS branding applied to admin dashboard.");
  }
}
